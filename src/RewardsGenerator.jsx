...
const REWARDS_DATA = [
    { id: 1, name: 'Dragon Evolutivo', image: '/rewards/Dragon_Transparente.png?v=4', color: '#FFD700', link: 'https://omg10.com/4/10193937' },
    { id: 2, name: 'M1014 Plasma', image: '/rewards/142-1420727_armas-de-free-fire-m4a1-hd-png-download.png?v=4', color: '#CC66FF', link: 'https://omg10.com/4/10615693' },
    { id: 3, name: 'Criminal Rojo', image: '/rewards/22fcc223f1d2144fb38b02146e0b8118.png?v=4', color: '#FF1A1A', link: 'https://omg10.com/4/10193957' },
    { id: 4, name: 'XM8 Evolutiva', image: '/rewards/2e9c951ed880XM8.png?v=4', color: '#00D4FF', link: 'https://omg10.com/4/10193949' },
    { id: 5, name: 'Personaje Otho', image: '/rewards/Otho-Aspecto-Catrin-de-Oro.png?v=4', color: '#FFB800', link: 'https://omg10.com/4/10193955' },
    { id: 6, name: 'Pase Elite T1', image: '/rewards/7755f31db2a8e7dc21e4ab09a8e3d910.png?v=4', color: '#8B00FF', link: 'https://omg10.com/4/10193950' },
    { id: 7, name: 'Mascota Lobo', image: '/rewards/796494dc5f4793d90db07ab22cafdc61.png?v=4', color: '#00FF88', link: 'https://omg10.com/4/10193953' },
    { id: 8, name: 'AK47 Unicornio', image: '/rewards/png-transparent-crossfire-gun-barrel-ranged-weapon-firearm-weapon-ak47-ammunition-weapon.png?v=4', color: '#FFD700', link: 'https://omg10.com/4/10193956' },
    { id: 9, name: 'Pantalón Angelical', image: '/rewards/d5c0af0ac8632385f2cdb0500874b2a5.png?v=4', color: '#00D4FF', link: 'https://omg10.com/4/10193951' },
    { id: 10, name: 'Andrew Renacido', image: '/rewards/Free-Fire-Andrew-Character.png?v=4', color: '#FFD700', link: 'https://omg10.com/4/10147861' },
    { id: 11, name: 'Mochila Especial', image: '/rewards/df51nxs-22ded7d4-60e3-498a-965c-fcd12b2a59ea.png?v=4', color: '#CC66FF', link: 'https://www.effectivegatecpm.com/rcbsrwxv58?key=4252999d93bfecfc4aa4dcf8f91fc03b' },
    { id: 12, name: 'Gorra Veterana', image: '/rewards/87c930cbb42948e28fbcdfe7301a0700.png?v=4', color: '#FF6B00', link: 'https://www.effectivegatecpm.com/wqgi71hemu?key=34a9f666596b818861f49f84becb685e' },
    { id: 13, name: 'SVD Roja', image: '/rewards/8011eaac73283d9e6dc63e7aa319d406.png?v=4', color: '#FF1A1A', link: 'https://www.effectivegatecpm.com/ttb74c8tq8?key=af1a97f37f5a027bd3d0829a26a90e6e' },
    { id: 14, name: 'Caja Armas', image: '/rewards/872c428c4aae92528ef78c2615fe45fd.png?v=4', color: '#00FF88', link: 'https://www.effectivegatecpm.com/pedjvcva?key=5509ba6b1262369b745cbbc664af8c5d' },
    { id: 15, name: 'Jeep Guerrerero', image: '/rewards/bc2841b06a25d96a6f4bf2b05d9d47f7.png?v=4', color: '#FF1A1A', link: 'https://www.effectivegatecpm.com/r4495dauq?key=0f15c64a0e85e948409ee9ae93dbff2b' },
    { id: 16, name: 'Muro Gloo', image: '/rewards/unnamed (1).png?v=4', color: '#00D4FF', link: 'https://www.effectivegatecpm.com/rgtfqwe9?key=17ef86cb7dfb7aaf61b51b12f8f1cdc5' },
    { id: 17, name: 'Ticket x10', image: '/rewards/images (1).png?v=4', color: '#CC66FF', link: 'https://www.effectivegatecpm.com/d1rfhq04x?key=4f4f9fdf2187e0f0c444b4be9a4a33d0' },
    { id: 18, name: 'Medallas Pase', image: '/rewards/images (2).png?v=4', color: '#FFD700', link: 'https://www.effectivegatecpm.com/w0u5v8geyf?key=9cc891f6d793faf25e8f4f4b71b85fb1' },
    { id: 19, name: 'Sartén Neón', image: '/rewards/images.png?v=4', color: '#00FF88', link: 'https://www.effectivegatecpm.com/b3yjr1t700?key=9a9698f66a79ca46b2bee9d3e44f0562' },
    { id: 20, name: 'Tarjeta XP', image: '/rewards/f0e9f3b4e99d48d1f8fc7361751a8f8f.png?v=4', color: '#FF6B00', link: 'https://omg10.com/4/10147861' }
];
